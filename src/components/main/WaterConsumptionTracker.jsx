  ...
  return (
    ...
    <div className={css.wrap_benefits}>
      <div className={css.head_benefits}>
        ...
        <h2 className={css.subtitle_benefits}>Record daily water intake and track</h2>
      </div>
      <div>
        <p className={css.list_title}>Tracker Benefits</p>
        <ul className={css.list_benefits}>
          <li className={css.item_benefits}>
            <img className={css.icon_benefits} src={calendar} alt="Calendar"/>
            <p>Habit drive</p>
          </li>
          <li className={css.item_benefits}>
            <img className={css.icon_benefits} src={chartbar} alt="Chartbar"/>
            <p>View statistics</p>
          </li>
          <li className={css.item_benefits}>
