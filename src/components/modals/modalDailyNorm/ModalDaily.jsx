            ...
            <div className={css.backdrop}>
                ...
                <p className={css.title}>My daily norma</p>
                    ...
                    <button type="button" className={css.closeBtn} onClick={handleClose} >
                        ...
                        <li>
                            <p className={css.gender}>For girl:
                                <span className={css.formula}>V=(M*0.03)+(T*0.4)</span>
                            </p>
                        </li>
                        <li>
                            <p className={css.gender}>For man:
                                <span className={css.formula}>V=(M*0.04)+(T*0.6)
                    ...
                    <form className={css.inputs} >
                        ...
                        <div className={css.labels}>
                            <label className={css.dataLabel}>The time of active participation in sports or other activities with a high physical. load:</label>
                            <input
                                onBlur={handleBlur}
                            type="number"
                            name="time"
                        ...
                        <p className={css.amount}>The required amount of water in liters per day:</p>
                        <p className={css.littres}>{result}L</p>
                    </div>
                    
                        <div className={css.labels}>
                            <label className={css.lastInput}>The required amount of water in liters per day:</label>
                           <input
                            type="number"
